...
class DrumMachine():
	...
	def save_project(self):
		...
		self.root.title(os.path.basename(file_name) + " - PyBeats")
	...
	def about(self):
		messagebox.showinfo("About", "Developed by barasingha")
				...
				for r in range(len(self.playlist)):
					try:
						if self.playlist[r][c] == 1:
							if not self.widget_drum_file_name[r]:
                                continue
